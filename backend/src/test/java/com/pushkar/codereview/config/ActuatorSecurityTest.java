...
@Import(ActuatorSecurityTest.TestConfig.class)
class ActuatorSecurityTest {
    ...
    @Test
    void testSensitiveActuatorEndpoints_AreNotExposed() throws Exception {
    ...
    @Test
    void testPublicActuatorEndpoints_AreAccessible() throws Exception {
